...
import { Funder } from "./CardItems/Funder";
...
import { Sniper } from "./CardItems/Sniper";
import { GameCardBase } from "./GameCardBase";

const chance = new Chance(); // instantiate

export const ShimoGameCard = ({ openSlip, cardIndex }) => {
  return (
    <GameCardBase openSlip={openSlip} cardIndex={cardIndex}>
      <HStack>
        ...
        <Funder />
        {chance.pickone([<Sniper />, null, null, null])}
        <Spacer />
        <GameCountdown />
      </HStack>
      <Pot />
